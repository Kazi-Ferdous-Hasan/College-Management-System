...
public class StaffsTable extends JFrame {

    public StaffsTable() throws IOException {
        DefaultTableModel dtm = new DefaultTableModel(0, 0);
        String header[] = new String[]{"NAME", "DESIGNATION", "AGE"};
       dtm.setColumnIdentifiers(header);
        ...
        remove.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (row > 0) {
                    ...
                    File inputFile = new File("E:\\Spring21\\CSE110\\College Management System\\src\\college\\management\\system\\StaffsInput.txt");
                    File tempFile = new File("E:\\Spring21\\CSE110\\College Management System\\src\\college\\management\\system\\StaffsTempFile.txt");
        ...
        File file = new File("E:\\Spring21\\CSE110\\College Management System\\src\\college\\management\\system\\StaffsInput.txt");
        try {
            if (!file.exists()) {
