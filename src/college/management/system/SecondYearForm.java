...
public class SecondYearForm extends JFrame{

    public SecondYearForm() {
        JLabel header = new JLabel("Add Second year students Information");
        header.setFont(new Font("Times New Roman",Font.BOLD,18));
        header.setBounds(250, 70, 400, 40);
        //header.setBounds(300, 80, 200, 40);
        add(header);
        JLabel nameLabel = new JLabel("Name: ");
        nameLabel.setBounds(220, 120, 200, 40);
        add(nameLabel);

        JLabel designationLabel = new JLabel("ID: ");
        designationLabel.setBounds(220, 170, 200, 40);
        add(designationLabel);

        JLabel ageLabel = new JLabel("Section: ");
